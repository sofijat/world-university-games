                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="col-md-5 align-items-center">
                                <label>Smeštaj: {{accomodationName}}</label><label ></label>
                                <br><br><br>
                                <b-button pill variant="info" to="/userAccomRate">Ocene</b-button>
                                <br><br><br>
                                <b-button pill variant="info" to="/userAccomComm">Komentari</b-button>
                                <br><br><br>
                                <b-button pill variant="info" to="/userAccomChg">Promeni smeštaj</b-button>
                            </div>
...
<script>
    ...
    created(){
        ...
        var id = user.accomodation;
        var accom  = this.accomodations.find(accom => accom.id == id);
        this.accomodationAddress = accom.address;
        this.accomodationName = accom.name;
        var lat1 = accom.lat;
        var lng1 = accom.lng;
