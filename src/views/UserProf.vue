...
<script>
  ...
  created() {
      this.name = this.users.find(user=> user.loggedIn==true).name;
      this.surname = this.users.find(user=> user.loggedIn==true).surname;
      this.phone = this.users.find(user=> user.loggedIn==true).phone;
      this.address = this.users.find(user=> user.loggedIn==true).address;
      this.username = this.users.find(user=> user.loggedIn==true).username;
      this.password = '***********';
      this.visible = false;
  },
  methods:{
